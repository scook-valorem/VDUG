...
# MAGIC %md # Vowpal Wabbit and LightGBM for a Regression Problem
# MAGIC 
...
# MAGIC [LightGBM](https://github.com/microsoft/LightGBM) with MMLSpark.
...
# MAGIC %md Following is the summary of the training set.
...
# MAGIC %md Plot feature distributions over different target values (house prices in our case).
...
# MAGIC %md ## Baseline - Spark MLlib Linear Regressor
# MAGIC 
...
# MAGIC %md See [VW wiki](https://github.com/vowpalWabbit/vowpal_wabbit/wiki/Command-Line-Arguments) for command line arguments.
...
# MAGIC %md Following figure shows the actual-vs.-prediction graphs of the results:
# MAGIC 
